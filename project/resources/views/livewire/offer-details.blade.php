<div>
    <div wire:ignore.self class="modal fade" id="offerDetails" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    color: #fff;">
      <div class="modal-body">
        @isset($getData->des)
        <ul>
          <li style="list-style-type: disc;margin-left: 19px;">{{$getData->des}} gg</li>
        </ul>
        @endisset
      </div>
