                              ...
                              <div class="product-card-thumb">
                                 <div class="product-card-thumb-inner">
                                    ...
                                    <div class="product-card-button">
                                       <a wire:click="$emit('addToCart', {{$cp->id}})" class="btn btn-yellow">Add To Cart</a>
                                    </div>
                                    @else
                                    <div class="product-card-button">
                                       <a wire:click="$emit('getModelDataOp', {{$cp->id}})" class="btn btn-yellow clicked">Commander</a>
                                    </div>
                                    @endif
                                 </div>
                              </div>
