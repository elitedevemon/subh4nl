                ...
                <div class="box_general padding_bottom">
                    ...
                    <div class="row">
                     <div class="col-md-4 text-center" style="margin-bottom: 5px">
                       <div class="card">
                         <div class="card-body">
                            <form action="{{route('aboutImageStore')}}" method="post" enctype="multipart/form-data">
                              @csrf
                          <div class="imageShow">
                             <img src="{{asset('storage/upload/aboutImage')}}/{{$aboutImage->img1}}" width="100px" height="80px" alt="">
                          </div>
