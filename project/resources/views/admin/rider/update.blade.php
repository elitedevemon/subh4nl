                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name" class="form-control" value="{{$rider->name}}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Address</label>
                                <input type="text" name="address" class="form-control" value="{{$rider->address}}"">
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Number</label>
                                <input type="text" name="phone" class="form-control" value="{{$rider->phone}}">
                            </div>
                        </div> 
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Email</label>
                                <input value="{{$rider->email}}" type="email" name="email" class="form-control">
                            </div>
                        </div>
                    </div>      
                </div>
