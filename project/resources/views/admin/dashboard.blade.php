            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card dashboard text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5"><h5>{{$data['todaySell']}}€ Today Sells</h5></div>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card dashboard text-white bg-warning o-hidden h-100">
                <div class="card-body">
                  <div class="card-body-icon">
                    ...
                    <div class="mr-5"><h5>{{$data['monthSell']}}€ Monthly Sells</h5></div>
                </div>
              ...
              <div class="card dashboard text-white bg-danger o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5"><h5>{{$data['yesterdaySell']}}€ Yesterday Sells </h5></div>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card dashboard text-white bg-success o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5"><h5>{{$data['todayOrderCount']}} Today Orders </h5></div>
                </div>
