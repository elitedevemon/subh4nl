                       ...
                       <div class="card">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group col-6">
                              <label><b>Not Discountable</b></label>
                               <div class="row">
                                <div class="col-2">
                                  <label class="switch" for="checkbox33">
                                    <input type="checkbox" id="checkbox33" name="discountable" value="1" />
                                    <div class="slider round"></div>
                                  </label>
                                </div>
                              </div>
                            ...
                            <div class="form-group col-12">
                              <label><b>Include Tax [Optional]</b></label>
                                    <input type="text" class="form-control" id="checkbox33" name="tax" placeholder="Include Tax [Optional]" />
                            </div>
                        ...
                        <div class="col-md-12" x-show="show">
                            <div class="form-group">
                                ...
                                <input type="text" name="sp_des" class="form-control" placeholder="Pizza + Burger + Chicken">
                            </div>
                        </div>

                        <div class="col-md-12" x-show="show">
                            <div class="form-group">
                                <label><b>Product Image For Special Banner V2 [optional] </b></label>
                         ...
                         <div class="col-md-12">
                            <div class="form-group">
                              <label><b>Product Options</b></label>
                               <div class="row">
                        @foreach($proTitle as $v_proTitle)
                                <div class="col-6">
                                  <label for="">
